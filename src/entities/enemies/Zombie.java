...
public class Zombie extends Enemy {
	...
	public Zombie(double x, double y) {
		...
		EntityDrop[] drops = {new EntityDrop(0.6,2,new Food(Food.Type.ZOMBIE_MEAT)),
	...
	public Image entityImage() {
		return Program.getImage("entities/enemies/zombie.png");
	}
	
	public Entity replicate() {
		Entity e = new Zombie(position.x,position.y);
