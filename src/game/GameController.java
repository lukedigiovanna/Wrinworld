...
public class GameController {
	...
	public static void saveCurrentGame(String name) {
		// if (true)
		// 	return; // its not working right now so don't do it.
		...
		// 	oOut.close();
		// 	JOptionPane.showMessageDialog(null, "Successfully saved world " + filePath, "Save Successful",
		// 			JOptionPane.INFORMATION_MESSAGE);
		// } catch (Exception e) {
		// 	e.printStackTrace();
		// 	JOptionPane.showMessageDialog(null, "Unable to save world " + filePath, "Save Failure",
