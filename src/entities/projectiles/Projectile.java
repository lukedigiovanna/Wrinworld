...
public class Projectile extends Entity {
	...
	public enum Type {
		ARROW("arrow.png", new Dimension(0.5,0.25),5.0,4),
		...
		ROCK("rock.png",new Dimension(0.375,0.1875),10.0,5),
		FIRE("fire","fireprojectile",5,new Dimension(0.375,0.375),4.0,1.5),
